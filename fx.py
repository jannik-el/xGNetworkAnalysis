...
def CreatexGDF(match_id):
    ...
    shots_team1_xg_minute = [0] + shots_team1_xg_minute + [(shots_team1_xg_minute[-1] + 1)]
    shots_team2_xg_minute = [0] + shots_team2_xg_minute + [(shots_team1_xg_minute[-1] + 1)]
    team1_xg_cumu = [0] + team1_xg_cumu.tolist() + [team1_xg_cumu.tolist()[-1]]
    team2_xg_cumu = [0] + team2_xg_cumu.tolist() + [team2_xg_cumu.tolist()[-1]]
